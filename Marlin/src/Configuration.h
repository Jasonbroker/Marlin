...
#define STRING_CONFIG_H_AUTHOR "Tinker_chinese" // Who made the changes.
#endif
...
// default settings
#ifdef UM2PLUS
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,400,385}  // default steps per unit for ultimaker2.1 JarJar
#else
